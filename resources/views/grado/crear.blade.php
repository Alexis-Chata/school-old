        ...
        <table id="tbl_anio" class="table table-striped table-bordered" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center"><a class="btn btn-primary btn-sm" href="{{ route('grado.edit',$value) }}">Editar</a></td>
                    <td class="text-center"><form action="{{ route('grado.destroy',$value)}}" method="POST">
                        @csrf
                        @method('delete')
